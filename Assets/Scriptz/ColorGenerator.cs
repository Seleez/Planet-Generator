...
public class ColorGenerator
{
    ...
    public void UpdateSettings(ColorSettings settings)
    {
        ...
        {
            texture = new Texture2D(textureResolution * 2, settings.biomeColorSettings.biomes.Length /*Textureformat = TextureFormat.RGB32,bool false*/);
        }
    ...
    public float BiomePercentFromPoint(Vector3 pointOnUnitSphere)
    {
        ...
        float blendRange = settings.biomeColorSettings.blend / 2f + .001f;
